"""Muamalat (مصرف الجمهورية) payment service."""
...
GATEWAY_SLUG = "muamalat"
_adapter = MuamalatGateway()


class MuamalatPaymentService:
    slug = GATEWAY_SLUG
...
muamalat_payment_service = MuamalatPaymentService()
